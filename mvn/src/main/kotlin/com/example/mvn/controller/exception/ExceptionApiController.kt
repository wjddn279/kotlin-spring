...
import com.example.mvn.model.http.Error
import com.example.mvn.model.http.ErrorResponse
...
//        val a = list[0]
    ...
    @ExceptionHandler(value = [MethodArgumentNotValidException::class])
     fun methodArgNotValidException(e: MethodArgumentNotValidException, request: HttpServletRequest): ResponseEntity<ErrorResponse> {
